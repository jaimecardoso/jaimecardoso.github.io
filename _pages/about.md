...
title: about
permalink: /
subtitle: INESC TEC · Faculty of Engineering, University of Porto  
...
<!-- <div style="margin-bottom: 20px; padding: 12px 16px; border-left: 4px solid #4c72b0; background-color: #f8f9fa;">
  <i class="ai ai-google-scholar" style="font-size: 1.2em;"></i>
  <strong>Google Scholar:</strong>
  <a href="https://scholar.google.com/citations?user=fadRi1YAAAAJ" target="_blank">
    View publications, citations, and metrics
  </a>
</div>-->

I am a [Full Professor](https://sigarra.up.pt/feup/en/FUNC_GERAL.FORMVIEW?p_codigo=367235) at the Department of Electrical and Computer Engineering (DEEC), [Faculty of Engineering of the University of Porto (FEUP)](http://www.fe.up.pt/), Portugal. I am also a researcher at [INESC TEC](http://www.inesctec.pt/) (Centre for Telecommunications and Multimedia).

My research lies at the intersection of **artificial intelligence**, **computer vision**, **medical imaging**, and **machine learning**, with a particular focus on developing **trustworthy AI systems** for healthcare. My interests include explainable AI, uncertainty quantification, robust machine learning, multimodal learning, computational pathology, and clinical decision support systems.

My goal is to develop AI methodologies that are not only accurate but also transparent, reliable, and clinically meaningful, enabling their safe integration into real-world healthcare workflows. I am particularly interested in bridging methodological advances in machine learning with impactful applications in medical imaging and digital pathology.

At INESC TEC, I co-founded:

- the Breast Research Group
- the [Visual Computing and Machine Intelligence (VCMI) Group](http://vcmi.inesctec.pt/)  

I have supervised numerous MSc and PhD students and regularly collaborate with academic institutions, hospitals, and industrial partners on national and international research projects.
...
<ul>
  <li><i class="ai ai-semantic-scholar"></i> <a href="https://www.semanticscholar.org/author/Jaime-S-Cardoso/3698192">Semantic Scholar</a></li>
